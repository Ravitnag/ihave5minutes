...
function App() {
  ...
  const getSuggestion = () => {
    ...
    const short = [
      'כתבי 3 צעדים קטנים שיקדמו אותך',
      'עשי פעולה קצרה שתקדם אותך אפילו בקטנה',
      'רק התחילי – 2 דקות של מיקוד!'
    ];
    const medium = [
      'קדמי חלק קטן מהמטרה – אפילו רק חצי משימה',
      'רשמי תוכנית פעולה זריזה והתחילי בשלב ראשון',
      'הקדישי זמן לסדר סביבתי שיתמוך במטרה'
    ];
    const long = [
      'פני חצי שעה לעבודה רצינית – תני פוש!',
      'צללי למשימה ונסי לסיים חלק משמעותי',
      'הכיני לעצמך שלד או טיוטה – תתחילי לבנות'
    ];
    ...
    <div className="p-6 max-w-md mx-auto text-center">
      ...
      {suggestion && (
        <div className="mt-6 bg-yellow-100 text-gray-800 p-4 rounded shadow">
          <p><strong>מטרה:</strong> {goal}</p>
          <p className="mt-2"><strong>הצעה:</strong> {suggestion}</p>
        </div>
      )}
    </div>
  );
